...
This concept covers read-heavy endpoints, repeated reads of shared data, database query tuning, replicas, sharding, application cache, CDN/edge cache, client and in-process cache, freshness, invalidation, hot keys, stampedes, penetration, avalanche, replication lag, and read-path observability. [[2026-05-14--scaling-reads|Scaling Reads]] [[2026-05-02--replication|Replication]] [[2026-05-24--caching|Caching]] It does not cover write-heavy scaling as the primary bottleneck, such as high-frequency location updates or collaborative editing conflict resolution. [[2026-05-14--scaling-reads|Scaling Reads]]
