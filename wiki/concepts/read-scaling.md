...
- **OLAP**: Read scaling can optimize product-facing reads, while OLAP separates historical analytical scans from OLTP paths. [[2026-04-15--database|Database]]
...
- [[2026-04-15--database|Database]] — The source distinguishes OLTP point access from OLAP historical scans, which prevents analytical queries from being mistaken for ordinary read scaling.
