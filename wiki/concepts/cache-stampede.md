...
A cache stampede is a failure mode where many requests miss or expire from cache for a hot key at the same time and overwhelm the backend system that must rebuild the cached answer. [[2026-05-14--scaling-reads|Scaling Reads]] [[2026-05-24--caching|Caching]] In distributed cache systems, stampedes can also happen during cold-cache warmup, node replacement, or broad routing churn. [[2026-05-15--distributed-cache|Distributed Cache]]

## Scope

This concept covers synchronized TTL expiration, backend overload, request coalescing, locks or single-flight rebuilds, TTL jitter, stale-while-revalidate, probabilistic early refresh, background refresh, stale-data fallback, warmup, and database fallback limits. [[2026-05-14--scaling-reads|Scaling Reads]] [[2026-05-24--caching|Caching]] [[2026-05-15--distributed-cache|Distributed Cache]]
