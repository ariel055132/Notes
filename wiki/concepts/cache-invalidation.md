...
Cache invalidation is the set of strategies used to stop stale cached data from being served beyond the system's acceptable freshness or correctness limits. [[2026-05-14--scaling-reads|Scaling Reads]] It includes write-time deletion or update, event-driven purge, versioned keys, short TTLs, distributed invalidation events, and CDN-specific choices such as versioned URLs versus global purge. [[2026-05-24--caching|Caching]] [[2026-05-15--distributed-cache|Distributed Cache]] [[2026-05-15--cdn-content-delivery-network|CDN (Content Delivery Network)]]

## Scope

This concept covers TTL, write-through updates, write-around/cache-aside, active deletion, event-driven invalidation, versioned keys, tagged invalidation, browser cache, CDN invalidation, purge latency, regional cache invalidation, and mixed strategies that treat critical and noncritical data differently. [[2026-05-14--scaling-reads|Scaling Reads]] [[2026-05-24--caching|Caching]] [[2026-05-15--distributed-cache|Distributed Cache]] [[2026-05-15--cdn-content-delivery-network|CDN (Content Delivery Network)]]
...
- **Versioned URL**: A versioned URL avoids mutating an existing CDN cache entry by publishing a new key, while purge removes or refreshes an existing key and may have propagation delay. [[2026-05-15--cdn-content-delivery-network|CDN (Content Delivery Network)]]
...
- [[2026-05-15--cdn-content-delivery-network|CDN (Content Delivery Network)]] — The source recommends long TTL plus versioned URLs for assets, short TTL for public but changing data, and purge for emergency removal or security fixes.
